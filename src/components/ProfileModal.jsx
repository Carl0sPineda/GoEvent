...
const ProfileModal = ({ show, onClose }) => {
    ...
    return (
        ...
        <div className="modal modal-sm" tabIndex="-1" role="dialog" style={{display: 'block',}}>
        <div className="modal-dialog" role="document">
          <div className="modal-content modal-with-background">
            <div className="modal-header">
              <label></label>
              <button type="button" className="close" onClick={onClose} style={{ fontSize: '10px' }}>
            ...
            <button type="button" className="ct-btn-primary" onClick={() => navigate("/Profile")}>Editar</button>
            {/* <button type="button" className="ct-btn-primary" onClick={onClose}>Cerrar</button> */}
            <button type="button" className="ct-btn-primary" onClick={onLogout}>Cerrar Sesion</button>
      </div>
          </div>
        </div>
      </div>
