...
export default function SingUp(){
  ...
  //   // Actualiza el arreglo interests con los valores seleccionados
  //   setFormData((prevState) => ({
  //     ...prevState,
  ...
  const handleSelectChange = (event) => {
    ...
    async function onSubmit(e) {
        ...
        try {
          const imgUrls = await Promise.all([...photo].map((image) => storeFile(image)));
          const auth = getAuth();
          ...
          // const docRef = await addDoc(collection(db, "users", user.uid), formDataCopy);
